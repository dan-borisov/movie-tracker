...
function SingleMovie() {
  ...
  return (
    <div>
        ...
        <div className="movie-box p-3 rounded">
            <div className="container">
                <div className="row">
                    <div className="col-md-4 d-none d-md-block">
                        <img className="img-fluid rounded" src={`https://image.tmdb.org/t/p/w342${movie.poster_path}`} alt={movie.title} />
                    </div>
                        ...
                        <div className="container-fluid px-0">
                            <div className="row justify-content-center align-items-center mx-0 my-5">
                                ...
                                <div className="col">
                                    ...
                                    <span style={{ verticalAlign: 'middle' }}> {(Math.round(movie.vote_average * 10) /10).toFixed(1)}</span>
                                </div>
                            </div>
                        </div>
                        <p>{movie.overview}</p>
